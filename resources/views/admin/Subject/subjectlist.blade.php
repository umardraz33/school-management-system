                                    ...
                                    <table id="example5" class="display text-nowrap" style="min-width: 845px">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                    <a href="{{url('admin/subject/edit/'.$value->id)}}" class="btn btn-xs sharp btn-primary"><i
                                                            class="fa fa-pencil"></i></a>
                                                    <a href="{{url('admin/subject/delete/'.$value->id)}}" class="btn btn-xs sharp btn-danger"><i
