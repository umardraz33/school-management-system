<ul class="metismenu" id="menu">
    <li class="nav-label first">Main Menu (Admin)</li>
    <li>
        <a class="ai-icon" href="{{url('admin/dashboard')}}" aria-expanded="false">
    ...
    <li>
        <a class="ai-icon" href="{{url('admin/admin/list')}}" aria-expanded="false">
            <i class="la la-calendar"></i>
            <span class="nav-text">Admins</span>
        </a>
    </li>
    <li>
        <a class="ai-icon" href="{{url('admin/class/list')}}" aria-expanded="false">
            <i class="la la-calendar"></i>
    ...
    <li>
        <a class="ai-icon" href="{{url('admin/subject/list')}}" aria-expanded="false">
            <i class="la la-calendar"></i>
