...
<body>
                            ...
                            <form action="" method="post" id="myForm">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary btn-block"
                                        id="submitButton">Reset Password</button>
                                </div>
                                <div id="submittingMessage" style="display:none; text-align: center;">
                                    <button type="submit" class="btn btn-primary btn-block">Processing...</button>
                                </div>
                            </form>
    ...
    <script>
        document.getElementById('myForm').addEventListener('submit', function (event) {
            ...
            // Hide the submit button and show the submitting message
