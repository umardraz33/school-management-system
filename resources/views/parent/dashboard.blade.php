        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="morris_donught_2" class="morris_chart_height ltr" style="height: 300px !important">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <img class="img-fluid rounded-top" src="public/images/courses/pic1.jpg" alt="" />
                    <div class="card-body">
                        <h4>
                            <a href="about-courses.html">When Is the Best Time to Take an Education Course?</a>
                        </h4>
                        <ul class="list-group mb-3 list-group-flush">
                            <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
                                <span class="mb-0">April 23</span>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <img class="img-fluid rounded-top" src="public/images/courses/pic2.jpg" alt="" />
                    <div class="card-body">
                        <h4>
                            <a href="about-courses.html">Education Courses: A Guide to Unlocking Your
                                Potential</a>
                        </h4>
                        <ul class="list-group mb-3 list-group-flush">
                            <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <img class="img-fluid rounded-top" src="public/images/courses/pic3.jpg" alt="" />
                    <div class="card-body">
                        <h4>
                            <a href="about-courses.html">A Comprehensive Guide to Taking an Education Course</a>
                        </h4>
                        <ul class="list-group mb-3 list-group-flush">
                            <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
                                <span class="mb-0">April 23</span>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <img class="img-fluid rounded-top" src="public/images/courses/pic4.jpg" alt="" />
                    <div class="card-body">
                        <h4>
                            <a href="about-courses.html">Why Should You Consider Taking an Education Course?</a>
                        </h4>
                        <ul class="list-group mb-3 list-group-flush">
                            <li class="list-group-item px-0 border-top-0 d-flex justify-content-between">
                                <span class="mb-0">April 23</span>
                            ...
                            <table class="table verticle-middle text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Jack Ronan</td>
                                        <td>
                                            <span id="widget_sparklinedash"><canvas></canvas></span>
                                        </td>
                                        <td>
